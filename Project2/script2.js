...
var contractAddress = '0x9141d63afDB4471701B865D05e65643E54F04396'; // FIXME: fill this in with your contract's address/hash
...
{
	return await BlockchainSplitwise.methods.getTotalOwed().call();
}
...
{
	return await BlockchainSplitwise.methods.getLastActive().call();
}
...
async function add_IOU(creditor, amount) 
{
	...
	var cyclePath = await doBFS(web3.eth.defaultAccount.toLowerCase(), creditor.toLowerCase(), getCreditorsOf);
	//TODO: remove cycle
	if(cyclePath){
